...
export default React.memo(function WithdrawalReceiptDialog() {
	...
	const { isFetching, isError, error, data } = useQuery(
		...
		{
			enabled: dialog.type === "withdrawal_receipt",
		}
	);
	...
	const open = React.useMemo(() => {
		return dialog.show && dialog.type === "withdrawal_receipt";
			...
			<ErrorBoundary>
				<Render isLoading={isFetching} isError={isError} error={error}>
					...
					<div className="flex flex-col gap-10">
						<h1 className="highlight-standard text-neutral-1000">Transaction Receipt</h1>

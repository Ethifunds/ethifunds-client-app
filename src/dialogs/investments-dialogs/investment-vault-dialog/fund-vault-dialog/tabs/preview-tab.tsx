...
export default React.memo(function PreviewTab(props: TabProps) {
	...
	const fundingSource = React.useMemo(() => {
		return fundingSources.find((item) => item.id === props.source)?.name ?? "wallet";
	}, [props.source, fundingSources]);
						...
						<div className="flex flex-col gap-8">
							...
							<div className="flex items-center gap-3 py-2 px-1 bg-[#FFECE7] text-neutral-1000 rounded-lg">
								...
								<p className="caption-standard">
									Note that the total amount will be withdrawn from your {fundingSource} and
									credited to your investment Vault
								</p>
							</div>

...
export default React.memo(function SuccessDialog() {
  ...
  const open = React.useMemo(() => {
    return dialog.show && dialog.type === "real-estate-marketplace-purchase-success";
  ...
  return (
    ...
    >
      <SuccessBox
        ...
        subtitle="Your investment request has been sent successfully. Kindly check your email for your investment details ."
        btnText="Dismiss"
        action={close}
      />
    </PopupModal>

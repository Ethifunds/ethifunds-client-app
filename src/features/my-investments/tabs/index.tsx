...
import { myInvestmentTabs } from "../data";
...
import ListedInvestments from "./listed-investments";
import CompletedInvestments from "./completed-investments";

type MyInvestmentTabProps = {
  data: MyActiveInvestment[];
};
export default function MyInvestmentTabs(props: MyInvestmentTabProps) {
  ...
  return (
    <ErrorBoundary>
      ...
      >
        ...
        <OngoingInvestments data={props.data} />
        <ExploreMarketplace />
        <ListedInvestments />

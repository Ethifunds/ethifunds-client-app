			...
			<div className="flex flex-wrap lg:gap-16">
				...
				<div className="flex flex-col gap-5 lg:w-[70%] pt-5 [&_p]:highlight-standard text-neutral-1000">
					...
					<div className="space-y-5">
						<p>
							The Ethifund Investment Vault is your secure digital vault for managing funds
							earmarked exclusively for investments. By separating your investment capital from your
							general wallet, you ensure your funds are safe and readily available for new
							opportunities.
						</p>
						<p>
					...
					<div className="flex items-start gap-3 p-4 bg-[#FFECE7] rounded-lg">
						...
						<p>
							By clicking continue I agree to the <b>Terms</b> and <b> Conditions</b> of the
							Ethifunds Investment Vault
						</p>
					</div>
